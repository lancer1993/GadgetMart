...
public class AbansItemAdapter extends RecyclerView.Adapter<AbansItemAdapter.AbansItemAHolder> {

    private Context context;
    private List<Item> list;

    public AbansItemAdapter(Context context, List<Item> list) {
    ...
    @NonNull
    @Override
    public AbansItemAHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_item_layout, parent, false);
        return new AbansItemAdapter.AbansItemAHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AbansItemAHolder holder, int position) {
    ...
    public static class AbansItemAHolder extends RecyclerView.ViewHolder {
        ...
        public AbansItemAHolder(@NonNull View itemView) {
            super(itemView);
