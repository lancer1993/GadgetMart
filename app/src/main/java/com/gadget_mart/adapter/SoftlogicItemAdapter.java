...
public class SoftlogicItemAdapter extends RecyclerView.Adapter<SoftlogicItemAdapter.SoftlogicItemAHolder> {

    private Context context;
    private List<Item> list;

    public SoftlogicItemAdapter(Context context, List<Item> list) {
    ...
    @NonNull
    @Override
    public SoftlogicItemAHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_item_layout, parent, false);
        return new SoftlogicItemAHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SoftlogicItemAHolder holder, int position) {
    ...
    public static class SoftlogicItemAHolder extends RecyclerView.ViewHolder {
        ...
        public SoftlogicItemAHolder(@NonNull View itemView) {
            super(itemView);
        ...
        public void bind(final Item item) {
            custom_item_name_text.setText(item.getItemName());
            ...
            BigDecimal sellingPrice = item.getActualPrice();
            ...
            Double tot = item.getActualPrice().doubleValue() * count;
            ...
            custom_item_qty_reduce_imageButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (count > 1) {
                        ...
                        Double total = item.getActualPrice().doubleValue() * count;
            ...
            custom_item_cart_imageButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (isAdded == true) {
                        ...
                        mainOrderDetails.setProductName(item.getItemName());
