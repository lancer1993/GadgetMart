...
public class AbansSaveSharedPreference {

    static final String PREF_USER_NAME= "abans_username";
    static final String PREF_USER_PASSWORD="abans_password";
    static final String PREF_USER_ID = "abans_userId";
    static final String PREF_USER_FULL_NAME = "abans_userFullName";
