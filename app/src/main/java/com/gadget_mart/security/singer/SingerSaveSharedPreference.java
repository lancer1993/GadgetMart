...
public class SingerSaveSharedPreference {

    static final String PREF_USER_NAME= "singer_username";
    static final String PREF_USER_PASSWORD="singer_password";
    static final String PREF_USER_ID = "singer_userId";
    static final String PREF_USER_FULL_NAME = "singer_userFullName";
